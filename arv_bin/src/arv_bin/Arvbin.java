...
public class Arvbin<T extends Comparable<T>>
{
    ...
    private Arvbin<T> esq, dir;
                                                ...
                                                /* Construtor de árvore sem sub-ávores
                                                *  (dir = esq = null). É fornecido apenas o valor da raiz. */
    ...
    public T calculaMaximo()
    {
        ...
        return val;
                                                   ...
                                                   /* Verifica se um valor está na árvore. Se estiver,
                                                    *  retorna um ponteiro para o nó que tem esse valor.
    ...
    public Arvbin<T> busca(T valor)
    {
        ...
        Arvbin<T> ret;
                                                   ...
                                                   /* Se é igual ao valor armazenado, não precisa procurar mais.
                                                    *  O nó é a raiz. */
